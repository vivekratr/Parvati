    ...
    <>
        <div className='mb-96'>
            <div className="relative w-full p-16  overflowx-hidden">
                <div className="flex  relative left-0    animate-marquee-infinite transition-all-but-transform duration-half-second ease-out ">
                    <div className=' flex w-[100%] transition-all-but-transform duration-half-second ease-out mr-[29rem] lg:mr-[2rem] lg:w-[150%] justify-around gap-12'>
                    ...
                    <div className=' flex w-[100%] lg:w-[150%] justify-around gap-9'>
                    {imgLinks.map((img)=>{
                        return(
