    ...
    <div className="flex  mb-8  flex-row max-h-24 max-w-full ">
      ...
      {isNavOpen && (
        ...
        />
          ...
          <p className="h-auto w-fit cursor-pointer mx-auto my-1"><Link to="section4" smooth={true} duration={1000}>Gallery</Link></p>
          <p className="h-auto w-fit cursor-pointer mx-auto my-1"><Link to="section3" smooth={true} duration={1000}>Amenities</Link></p>
          <p className="h-auto w-fit cursor-pointer mx-auto my-1"><Link to="section5" smooth={true} duration={1000}>Floor Plans</Link></p>
          <p className="h-auto w-fit cursor-pointer mx-auto my-1"><Link to="section7" smooth={true} duration={1000}>Virtual Tours</Link></p>
          <p className="h-auto w-fit cursor-pointer mx-auto my-1"><Link to="section8" smooth={true} duration={1000}>Our Partners</Link></p>
          <div  onClick={()=>{
            props.a(true)
          }} className="mx-auto cursor-pointer h-16 max-w-[13rem] w-[2.25] my-4 rounded-[46px] bg-yellow-600 overflow-hidden flex flex-row items-center justify-center py-[0.56rem] px-[0.94rem] box-border">
